...
```toml
# 仅 MySQL
yang-db = { version = "0.1.5", default-features = false, features = ["mysql"] }

# 仅 PostgreSQL
yang-db = { version = "0.1.5", default-features = false, features = ["postgres"] }

# 仅 Redis
yang-db = { version = "0.1.5", default-features = false, features = ["redis"] }
```
