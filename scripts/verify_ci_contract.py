...
REQUIRED_FRAGMENTS = (
    ...
    "cargo test --all-targets -p yang-base-derive -p yang-migrate -p yang-pcg -p yang-runtime --locked",
    "cargo clippy -p yang-db -p yang-base -p yang-base-derive -p yang-migrate -p yang-pcg -p yang-runtime --all-targets --all-features --locked -- -D warnings",
    ...
    "python scripts/run_performance_shadow.py --output target/performance-shadow",
    "actions/upload-artifact@v7",
    "if: always()",
    "path: target/performance-shadow",
