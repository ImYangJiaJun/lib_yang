...
CASES = (
    ...
    Case("yang-base-none", "yang-base", ("--no-default-features",), frozenset(), frozenset({"sqlx", "redis", "deadpool-redis", "reqwest", "jsonwebtoken"})),
    Case("yang-base-token", "yang-base", ("--no-default-features", "--features", "token"), frozenset({"jsonwebtoken", "redis", "deadpool-redis"}), frozenset({"sqlx", "sqlx-mysql", "sqlx-postgres", "reqwest"})),
    Case("yang-base-http", "yang-base", ("--no-default-features", "--features", "http"), frozenset({"reqwest"}), frozenset({"sqlx", "redis", "deadpool-redis", "jsonwebtoken"})),
    Case("yang-base-mysql", "yang-base", ("--no-default-features", "--features", "mysql"), frozenset({"sqlx", "sqlx-mysql"}), frozenset({"sqlx-postgres", "redis", "deadpool-redis", "reqwest", "jsonwebtoken"})),
    Case("yang-base-redis", "yang-base", ("--no-default-features", "--features", "redis"), frozenset({"redis", "deadpool-redis"}), frozenset({"sqlx", "sqlx-mysql", "sqlx-postgres", "reqwest", "jsonwebtoken"})),
)
